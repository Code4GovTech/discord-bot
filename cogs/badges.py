...
class BadgeModal(discord.ui.Modal, title="Your Badges"):
    select = discord.ui.Select(
        placeholder="Choose Badge Type", options=["Points Based", "Achievement Based"]
    )
...
"""
        ...
        self.apprenticeBadge = discord.Embed(
            title="Apprentice Badge", description=apprentinceDesc
        )
        self.converserBadge = discord.Embed(
            title="Converser Badge", description=converseDesc
        )
        self.rockstarBadge = discord.Embed(
            title="Rockstar Badge", description=rockstarDesc
        )
        self.enthusiastBadge = discord.Embed(
            title="Enthusiast Badge", description=enthusiastDesc
        )
        self.risingStarBadge = discord.Embed(
            title="Rising Star Badge", description=risingStarDesc
        )
        self.discordXGithubBadge = discord.Embed(
            title="Discord X Github Badge", description=dicordXGithubDesc
        )
        self.wizardBadge = discord.Embed(
            title="Wizard Badge", description=wizardBadgeDesc
        )
        self.ninjaBadge = discord.Embed(title="Ninja Badge", description=ninjaBadgeDesc)
        self.warriorBadge = discord.Embed(
            title="Warrior Badge", description=warriorBadgeDesc
        )

        self.apprenticeBadge.set_image(
            url="https://raw.githubusercontent.com/Code4GovTech/discord-bot/main/assets/Apprentice.png"
        )
        self.converserBadge.set_image(
            url="https://raw.githubusercontent.com/Code4GovTech/discord-bot/main/assets/Converser.png"
        )
        self.rockstarBadge.set_image(
            url="https://raw.githubusercontent.com/Code4GovTech/discord-bot/main/assets/Rockstar.png"
        )
        self.enthusiastBadge.set_image(
            url="https://raw.githubusercontent.com/Code4GovTech/discord-bot/main/assets/Enthusiast.png"
        )
        self.risingStarBadge.set_image(
            url="https://raw.githubusercontent.com/Code4GovTech/discord-bot/main/assets/RisingStar.png"
        )
        self.discordXGithubBadge.set_image(
            url="https://raw.githubusercontent.com/Code4GovTech/discord-bot/main/assets/Discord+Github.png"
        )
        self.wizardBadge.set_image(
            url="https://raw.githubusercontent.com/Code4GovTech/discord-bot/main/assets/Wizard.jpeg"
        )
        self.ninjaBadge.set_image(
            url="https://raw.githubusercontent.com/Code4GovTech/discord-bot/main/assets/Ninja.jpg"
        )
        self.warriorBadge.set_image(
            url="https://raw.githubusercontent.com/Code4GovTech/discord-bot/main/assets/Warrior.jpeg"
        )
    ...
    async def show_badges(self, ctx):
        ...
        if isinstance(ctx.channel, discord.DMChannel):
            ...
            infoEmbed = discord.Embed(
                title="Point System",
                description="If you want to understand more about the points & badge system, check out this [link](https://github.com/Code4GovTech/C4GT/wiki/Point-System-for-Contributors).",
            )
            ...
            user_badges = {
                "points": [
                    BadgeContents(name).enthusiastBadge,
                    BadgeContents(name).rockstarBadge,
                    BadgeContents(name).wizardBadge,
                ],
                "achievements": [
                    BadgeContents(name).apprenticeBadge,
                    BadgeContents(name).converserBadge,
                ],
            }
            embed = discord.Embed(
                title="Badge Type",
                description="What badge type do you want to view?",
                color=discord.Color.blue(),
            )
            embed.set_footer(
                text="Please react with 📈 for Points Based Badges or 🥳 Achievements Based Badges ."
            )
